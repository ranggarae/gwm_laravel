...
class EventsController extends Controller
{
    ...
    public function events_management(){
        ...
        $all_categories = EventsCategory::all()->groupBy('lang');
        $all_attendance_logs = EventAttendance::orderBy('id','desc')->get();
        $all_event_logs = EventPaymentLogs::orderBy('id','desc')->get();

        return view('backend.events.events-management')->with([
            'all_events' => $all_events,
            'all_languages' => $all_languages,
            'all_categories' => $all_categories,
            'all_attendance_logs' => $all_attendance_logs,
