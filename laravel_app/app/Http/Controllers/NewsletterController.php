...
class NewsletterController extends Controller
{
    ...
    public function newsletter_management(){
        $all_subscriber = Newsletter::all();
        return view('backend.newsletter.newsletter-management')->with(['all_subscriber' => $all_subscriber]);
    }
    ...
    public function delete($id){
        ...
        return redirect()->back()->with(['msg' => __('Subscriber Deleted....'),'type' => 'danger']);
    }
