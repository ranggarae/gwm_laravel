                    ...
                    @if(cart_total_items() > 0)
                        <div class="checkout-wrapper">
                                    ...
                                    <div class="tab-content" >
                                        ...
                                        <div class="tab-pane fade @if(auth()->check()) show active @endif" id="nav-profile" role="tabpanel">
                                            <form action="{{route('frontend.products.checkout')}}" method="post" enctype="multipart/form-data" class="contact-form order-form checkout-form" id="checkout_form">
                                                @csrf
                                                <input type="hidden" name="selected_payment_gateway" id="site_global_payment_gateway" value="{{get_static_option('site_default_payment_gateway')}}">
                            ...
                            <div class="cart-total-wrap">
                                ...
                                @endif
                                <a href="{{route('frontend.products.checkout')}}" class="boxed-btn checkout_form_submit_btn">{{__('Confirm Order')}}</a>
                            </div>
                        </div>
                    @else
