                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap">
                            ...
                            <a href="{{route('admin.knowledge.all')}}" class="btn btn-xs btn-primary"><i class="fas fa-angle-double-left"></i>{{__('All Articles')}}</a>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select name="lang" id="language" class="form-control">
                                            @foreach($all_languages as $lang)
                                                <option @if($articles->lang == $lang->slug)@endif value="{{$lang->slug}}">{{$lang->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="kncontent" value="{{$articles->content}}">
                                        <div class="summernote" data-content='{{$articles->content}}'></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="meta_tags">{{__('Meta Tags')}}</label>
                                        <input type="text" name="meta_tags"  class="form-control" data-role="tagsinput" id="meta_tags" value="{{$articles->meta_tags}}">
                                    </div>
                                    <div class="form-group">
