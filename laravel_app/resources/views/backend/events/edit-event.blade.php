                ...
                <div class="card">
                    <div class="card-body">
                       <div class="header-wrap">
                           <h4 class="header-title">{{__('Edit Event Post')}}</h4>
                           <a href="{{route('admin.events.all')}}" target="_blank" class="btn btn-primary btn-xs"><i class="fas fa-angle-double-left"></i>{{__('All Event Posts')}}</a>
                       </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  id="available_tickets" value="{{$event->available_tickets}}" name="available_tickets" placeholder="{{__('available tickets')}}">
                                    </div>
                                    <div class="form-group">
