    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('Price Plan Management')}}</h4>
                        
                        <ul class="nav nav-tabs" id="pricePlanTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#price-plans" role="tab">{{__('Price Plans')}}</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content margin-top-40" id="pricePlanTabContent">
                            <!-- TAB: Price Plans -->
                            <div class="tab-pane fade show active" id="price-plans" role="tabpanel">
                                <div class="row">
                                    <div class="col-lg-8 border-right">
                                        ...
                                        <div class="tab-content margin-top-40" id="langTabContent">
                                            @php $b=0; @endphp
                                            @foreach($all_price_plan as $key => $plan)
                                                            ...
                                                            @foreach($plan as $data)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href="#" data-toggle="modal" data-target="#price_plan_item_edit_modal" class="btn btn-primary btn-xs mb-3 mr-1 price_plan_edit_btn"
                                                                           data-id="{{$data->id}}"
        ...
        $(document).ready(function () {
            ...
            $('a[data-toggle="tab"]').on('show.bs.tab', function(e) {
                ...
                if (target.startsWith('#slider_tab_')) {
                    localStorage.setItem('activePricePlanLangTab', target);
                } else if (target.startsWith('#nav-home-')) {
                    localStorage.setItem('activePricePlanSettingsLangTab', target);
                } else {
                    localStorage.setItem('activePricePlanTab', target);
                }
            });

            var activeTab = localStorage.getItem('activePricePlanTab');
            if(activeTab){
                $('#pricePlanTab a[href="' + activeTab + '"]').tab('show');
            }
            var activeLangTab = localStorage.getItem('activePricePlanLangTab');
            if(activeLangTab){
                $('#langTab a[href="' + activeLangTab + '"]').tab('show');
            }
            var activeSettingsLangTab = localStorage.getItem('activePricePlanSettingsLangTab');
            ...
            $(document).on('click','.price_plan_edit_btn',function(){
                ...
                if(el.data('urlstatus') != ''){
                    ...
                    form.find('#edit_url_status').attr('checked',false);
                    form.find('#edit_url_status').parent().parent().next().show();
                }
            });
