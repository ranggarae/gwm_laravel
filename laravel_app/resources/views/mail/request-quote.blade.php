...
<head>
    ...
    <title>{{__('Request Quote From ').get_static_option('site_'.get_default_language().'_title')}}</title>
    <style>
        .mail-container {
            max-width: 650px;
            margin: 0 auto;
...
<body>
    <div class="mail-container">
        ...
        <p>{{__('You Have A Quote From '. get_static_option('site_'.get_default_language().'_title'))}}</p>
        <table>
