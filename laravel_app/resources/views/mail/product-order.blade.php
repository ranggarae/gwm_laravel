    ...
    <div class="mail-container">
        ...
        <div class="brief-wrapper">
           <p> {{__('Hey')}} {{$data->billing_name}}</p>
            <p>{{__('Your order #'.$data->id)}} {{__('has been placed on '.date_format($data->created_at,'d F Y H:m:s'))}} {{__('via '.ucwords(str_replace('_',' ',$data->payment_gateway)).'. You will be updated with another email after your item(s) has been shipped.')}}</p>
        </div>
        @else
        <div class="description">
