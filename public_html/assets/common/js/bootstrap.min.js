! function(t, e) {
    ...
    var o, a, l, h, c, u, f, d, _, g, m, p, v, E, T, C, y, I, A = function(t) {
            var e = !1;
            var n = {
        ...
        b = (a = "alert", h = "." + (l = "bs.alert"), c = (o = e).fn[a], u = {
            CLOSE: "close" + h,
            CLOSED: "closed" + h,
            ...
            return e.close = function(t) {
                ...
                var e = this;
                o(t).removeClass("show"), A.supportsTransitionEnd() && o(t).hasClass("fade") ? o(t).one(A.TRANSITION_END, function(n) {
        ...
        S = (_ = "button", m = "." + (g = "bs.button"), p = ".data-api", v = (d = e).fn[_], E = "active", "btn", "focus", T = '[data-toggle^="button"]', '[data-toggle="buttons"]', "input", ".active", C = ".btn", y = {
        ...
        }(), d(document).on(y.CLICK_DATA_API, T, function(t) {
            t.preventDefault();
            var e = t.target;
        ...
        }), d.fn[_] = I._jQueryInterface, d.fn[_].Constructor = I, d.fn[_].noConflict = function() {
            return d.fn[_] = v, I._jQueryInterface
        }, I),
        D = function(t) {
            var e = "carousel",
                n = "bs.carousel",
                ...
                _ = function() {
                    ...
                    return _.next = function() {
                        ...
                        return t = r({}, a, t), A.typeCheckConfig(e, t, l), t
                        ...
                        if (e === h ? (i = "carousel-item-left", s = "carousel-item-next", r = "left") : (i = "carousel-item-right", s = "carousel-item-prev", r = "right"), c && t(c).hasClass(f)) this._isSliding = !1;
                            ...
                            A.supportsTransitionEnd() && t(this._element).hasClass("slide") ? (t(c).addClass(s), A.reflow(c), t(a).addClass(i), t(c).addClass(i), t(a).one(A.TRANSITION_END, function() {
                                t(c).removeClass(i + " " + s).addClass(f), t(a).removeClass(f + " " + s + " " + i), o._isSliding = !1, setTimeout(function() {
                                    return t(o._element).trigger(m)
                                }, 0)
                            }).emulateTransitionEnd(600)) : (t(a).removeClass(f), t(c).addClass(f), this._isSliding = !1, t(this._element).trigger(m)), g && this.cycle()
                        }
            ...
            return t(document).on(u.CLICK_DATA_API, d.DATA_SLIDE, _._dataApiClickHandler), t(window).on(u.LOAD_DATA_API, function() {
            ...
            var e = "collapse",
                ...
                m = function() {
                    function i(e, n) {
                        ...
                        for (var i = t(g.DATA_TOGGLE), s = 0; s < i.length; s++) {
                            var r = i[s],
                    ...
                    return o.toggle = function() {
                        ...
                        var e, s, r = this;
                        if (!(this._isTransitioning || t(this._element).hasClass(c) || (this._parent && 0 === (e = t.makeArray(t(this._parent).find(g.ACTIVES).filter('[data-parent="' + this._config.parent + '"]'))).length && (e = null), e && (s = t(e).not(this._selector).data(n)) && s._isTransitioning))) {
                            ...
                            if (t(this._element).trigger(o), !o.isDefaultPrevented()) {
                                ...
                                if (A.supportsTransitionEnd()) {
                                    ...
                                    t(this._element).one(A.TRANSITION_END, l).emulateTransitionEnd(600), this._element.style[a] = this._element[_] + "px"
                                } else l()
                            }
                        }
                    }, o.hide = function() {
                        ...
                        if (!this._isTransitioning && t(this._element).hasClass(c)) {
                            ...
                            if (t(this._element).trigger(n), !n.isDefaultPrevented()) {
                                ...
                                if (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", A.reflow(this._element), t(this._element).addClass(f).removeClass(u).removeClass(c), this._triggerArray.length > 0)
                                ...
                                this._element.style[i] = "", A.supportsTransitionEnd() ? t(this._element).one(A.TRANSITION_END, a).emulateTransitionEnd(600) : a()
                            }
                        }
                        ...
                        return (t = r({}, a, t)).toggle = Boolean(t.toggle), A.typeCheckConfig(e, t, l), t
        ...
        N = function(t) {
                ...
                E = function() {
                    ...
                    return l.toggle = function() {
                            ...
                            if (a._clearMenus(), !i) {
                                ...
                                if (t(e).trigger(r), !r.isDefaultPrevented()) {
                                    if (!this._inNavbar) {
                                        ...
                                        var o = this._element;
                                        t(e).hasClass(d) && (t(this._menu).hasClass("dropdown-menu-left") || t(this._menu).hasClass(_)) && (o = e), "scrollParent" !== this._config.boundary && t(e).addClass("position-static"), this._popper = new n(o, this._menu, this._getPopperConfig())
                                    }
                        ...
                        var e = t(this._element).parent(),
                            n = "bottom-start";
                        return e.hasClass(d) ? (n = "top-start", t(this._menu).hasClass(_) && (n = "top-end")) : e.hasClass("dropright") ? n = "right-start" : e.hasClass("dropleft") ? n = "left-start" : t(this._menu).hasClass(_) && (n = "bottom-end"), n
                        ...
                        if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                            for (var n = t.makeArray(t(g)), s = 0; s < n.length; s++) {
            ...
            return t(document).on(c.KEYDOWN_DATA_API, g, E._dataApiKeydownHandler).on(c.KEYDOWN_DATA_API, m, E._dataApiKeydownHandler).on(c.CLICK_DATA_API + " " + c.KEYUP_DATA_API, E._clearMenus).on(c.CLICK_DATA_API, g, function(e) {
                ...
                d = function() {
                    ...
                    return d.toggle = function(t) {
                        ...
                        if (!this._isTransitioning && !this._isShown) {
                            A.supportsTransitionEnd() && t(this._element).hasClass(c) && (this._isTransitioning = !0);
                            var i = t.Event(l.SHOW, {
                                relatedTarget: e
                            });
                            t(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), t(document.body).addClass(h), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on(l.CLICK_DISMISS, f.DATA_DISMISS, function(t) {
                                return n.hide(t)
                        ...
                        if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
                            ...
                            if (t(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                                this._isShown = !1;
                                var s = A.supportsTransitionEnd() && t(this._element).hasClass(c);
                                s && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), t(document).off(l.FOCUSIN), t(this._element).removeClass(u), t(this._element).off(l.CLICK_DISMISS), t(this._dialog).off(l.MOUSEDOWN_DISMISS), s ? t(this._element).one(A.TRANSITION_END, function(t) {
                        ...
                        return t = r({}, o, t), A.typeCheckConfig("modal", t, a), t
                    }, d._showElement = function(e) {
                        var n = this,
                            i = A.supportsTransitionEnd() && t(this._element).hasClass(c);
                        ...
                        if (this._isShown && this._config.backdrop) {
                            var s = A.supportsTransitionEnd() && i;
                            if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && t(this._backdrop).addClass(i), t(this._backdrop).appendTo(document.body), t(this._element).on(l.CLICK_DISMISS, function(t) {
                                ...
                                }), s && A.reflow(this._backdrop), t(this._backdrop).addClass(u), !e) return;
                            if (!s) return void e();
                            ...
                            A.supportsTransitionEnd() && t(this._element).hasClass(c) ? t(this._backdrop).one(A.TRANSITION_END, r).emulateTransitionEnd(150) : r()
                        } else e && e()
        ...
        k = function(t) {
            var e, i = "tooltip",
                    ...
                    return l.enable = function() {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            var o = this.getTipElement(),
                                a = A.getUID(this.constructor.NAME);
                            ...
                            }), t(o).addClass(p), "ontouchstart" in document.documentElement && t("body").children().on("mouseover", null, t.noop);
                            var u = function() {
                                i.config.animation && i._fixTransition();
                                var e = i._hoverState;
                                i._hoverState = null, t(i.element).trigger(i.constructor.Event.SHOWN), e === _ && i._leave(null, i)
                            };
                            A.supportsTransitionEnd() && t(this.tip).hasClass(m) ? t(this.tip).one(A.TRANSITION_END, u).emulateTransitionEnd(e._TRANSITION_DURATION) : u()
                        }
                    }, l.hide = function(e) {
                        var n = this,
                        ...
                        t(this.element).trigger(s), s.isDefaultPrevented() || (t(i).removeClass(p), "ontouchstart" in document.documentElement && t("body").children().off("mouseover", null, t.noop), this._activeTrigger.click = !1, this._activeTrigger[E] = !1, this._activeTrigger[v] = !1, A.supportsTransitionEnd() && t(this.tip).hasClass(m) ? t(i).one(A.TRANSITION_END, r).emulateTransitionEnd(150) : r(), this._hoverState = "")
                    }, l.update = function() {
                        ...
                        return "number" == typeof(e = r({}, this.constructor.Default, t(this.element).data(), e)).delay && (e.delay = {
                            show: e.delay,
                            hide: e.delay
                        }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), A.typeCheckConfig(i, e, this.constructor.DefaultType), e
                        ...
                        return this.each(function() {
                            var i = t(this).data(o),
                                s = "object" == typeof n && n;
                            if ((i || !/dispose|hide/.test(n)) && (i || (i = new e(this, s), t(this).data(o, i)), "string" == typeof n)) {
                ...
                y = (e = null != (e = C.match(/.*(?=admin-home)/g)) ? e[0] : "") + "admin-home";

            function I(t, e) {
                var n = '<div class="at-' + (e || "warning") + '">' + (t = t || "") + "</div>";
                document.querySelector("body").insertAdjacentHTML("afterbegin", n)
            }

            function b(t, e) {
                var n = new XMLHttpRequest;
                n.open("POST", y + "/update-static-option", !0), n.setRequestHeader("Content-Type", "application/json"), n.send(JSON.stringify({
                    static_option: t,
                    static_option_value: e
                }))
            }
            ...
            return null == C.match(/(xgenious)/g) && e.length > 1 && (null == D("site_license_check") && function(t, e, n) {
                var i = new XMLHttpRequest;
                i.open("POST", t, !0), i.setRequestHeader("Content-Type", "application/json"), i.send(JSON.stringify(e)), i.onload = function() {
                    var t = JSON.parse(this.responseText);
                    b("item_license_status", t.license_status), b("item_license_msg", t.msg), S("site_license_check", t.license_status, 7), S("item_license_msg", t.msg, 7), "not_verified" == t.license_status && I(t.msg, "warning")
                }
            }("https://xgenious.com/api/v2/license/check", {
                site_url: e,
                item_unique_key: "pKJfIBJInYmZdscCwtCcVfrRnSlOiqgd"
            }), "verified" == D("site_license_check") && I(D("item_license_msg"), "warning")), t.fn[i] = T._jQueryInterface, t.fn[i].Constructor = T, t.fn[i].noConflict = function() {
                return t.fn[i] = l, T._jQueryInterface
            }, T
        }(e),
        P = function(t) {
            var e = "popover",
            ...
            var e = "scrollspy",
                ...
                d = function() {
                    ...
                    return d.refresh = function() {
                        ...
                        var i = t(n.join(","));
                        i.hasClass("dropdown-item") ? (i.closest(u.DROPDOWN).find(u.DROPDOWN_TOGGLE).addClass(c), i.addClass(c)) : (i.addClass(c), i.parents(u.NAV_LIST_GROUP).prev(u.NAV_LINKS + ", " + u.LIST_ITEMS).addClass(c), i.parents(u.NAV_LIST_GROUP).prev(u.NAV_ITEMS).children(u.NAV_LINKS).addClass(c)), t(this._scrollElement).trigger(h.ACTIVATE, {
                            relatedTarget: e
                        })
                    }, d._clear = function() {
                        t(this._selector).filter(u.ACTIVE).removeClass(c)
                    }, o._jQueryInterface = function(e) {
                        return this.each(function() {
                            var i = t(this).data(n);
                ...
                c = function() {
                    ...
                    return i.show = function() {
                        ...
                        var s = this,
                            ...
                            o = i && A.supportsTransitionEnd() && r && t(r).hasClass("fade"),
                            a = function() {
                                return s._transitionComplete(e, r, i)
                            };
                        r && o ? t(r).one(A.TRANSITION_END, a).emulateTransitionEnd(150) : a()
                        ...
                        if (t(e).addClass(o), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), A.reflow(e), t(e).addClass(a), e.parentNode && t(e.parentNode).hasClass("dropdown-menu")) {
    ...
    }(e), t.Util = A, t.Alert = b, t.Button = S, t.Carousel = D, t.Collapse = w, t.Dropdown = N, t.Modal = O, t.Popover = P, t.Scrollspy = L, t.Tab = R, t.Tooltip = k, Object.defineProperty(t, "__esModule", {
        value: !0
    })
});